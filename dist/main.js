...
}var $author$project$PostCodeSearch$Msg$UrlChangeRequested = function (a) {
	return {$: 'UrlChangeRequested', a: a};
};
var $author$project$PostCodeSearch$Msg$UrlChanged = function (a) {
...
var $author$project$PostCode$DTO$PostCode$PostCode = F3(
...
var $author$project$PostCode$DTO$PostCode$postCodeDecoder = A3(
	...
	A3(
		...
		A3(
			...
			'postcode',
			$elm$json$Json$Decode$string,
			$elm$json$Json$Decode$succeed($author$project$PostCode$DTO$PostCode$PostCode))));
var $author$project$PostCode$DTO$ValidResponse$ValidResponse = F2(
...
var $author$project$PostCodeSearch$Model$initialCode = A2(
	$elm$core$Basics$composeL,
	$elm$core$Maybe$andThen($elm$url$Url$percentDecode),
	$elm$url$Url$Parser$parse($elm$url$Url$Parser$string));
...
var $author$project$PostCodeSearch$Model$initialState = F2(
	function (url, key) {
		return {
			...
			code: A2(
				...
				'',
				$author$project$PostCodeSearch$Model$initialCode(url)),
			error: $elm$core$Maybe$Nothing,
			found: $elm$core$Maybe$Nothing,
			key: key,
			loading: false,
			nearest: $elm$core$Maybe$Nothing,
			url: url
		};
	});
...
var $author$project$Main$init = F3(
	function (flags, url, key) {
		return _Utils_Tuple2(
			A2($author$project$PostCodeSearch$Model$initialState, url, key),
			function () {
				var _v0 = $author$project$PostCodeSearch$Model$initialCode(url);
				if (_v0.$ === 'Just') {
					var code = _v0.a;
					return A2(
...
var $author$project$PostCodeSearch$Update$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'DoNothing':
			...
			case 'UpdateCode':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							autocompleteLoading: !$elm$core$String$isEmpty(code),
							code: code,
							error: $elm$core$Maybe$Nothing
						}),
					$elm$core$String$isEmpty(code) ? $elm$core$Platform$Cmd$none : A2(
						$elm$core$Platform$Cmd$map,
						$author$project$PostCodeSearch$Msg$Api,
						$author$project$PostCode$Client$getAutocomplete(code)));
			case 'SubmitCode':
				var code = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						...
						if (result.$ === 'Ok') {
							...
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										autocomplete: $elm$core$Maybe$Just(value),
										autocompleteLoading: false,
										error: $elm$core$Maybe$Nothing
									}),
								$elm$core$Platform$Cmd$none);
...
var $author$project$PostCodeSearch$CodeInputHtml$submitOnEnter = F2(
	function (postCode, keyCode) {
		if (keyCode === 13) {
			return $author$project$PostCodeSearch$Msg$SubmitCode(postCode);
		} else {
			return $author$project$PostCodeSearch$Msg$DoNothing;
		}
	});
var $elm$html$Html$Attributes$type_ = $elm$html$Html$Attributes$stringProperty('type');
var $elm$html$Html$Attributes$value = $elm$html$Html$Attributes$stringProperty('value');
var $author$project$PostCodeSearch$CodeInputHtml$codeInput = F2(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$author$project$Common$EventHandlers$onKeyDown(
...
var $author$project$Common$ErrorInfoHtml$errorInfo = function (error) {
	switch (error.$) {
		case 'BadUrl':
			var string = error.a;
			return $elm$html$Html$text('Bad Url: ' + string);
		case 'Timeout':
...
var $author$project$Main$main = $elm$browser$Browser$application(
	{init: $author$project$Main$init, onUrlChange: $author$project$PostCodeSearch$Msg$UrlChanged, onUrlRequest: $author$project$PostCodeSearch$Msg$UrlChangeRequested, subscriptions: $author$project$Main$subscriptions, update: $author$project$PostCodeSearch$Update$update, view: $author$project$Main$view});
